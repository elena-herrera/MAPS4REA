...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
            ...
            &lt;!--[if gt IE 8]&gt;&lt;!--&gt; &lt;html class=&quot;no-js&quot; lang=&quot;en&quot;&gt; &lt;!--&lt;![endif]--&gt;
				...
				<div class="container">
			    	    <div class="row">
    					     ...
    					     <img src="{$theme-path}images/BANNER.jpg" width="100%" height="100%" />
                                ...
                                <div class="row row-offcanvas row-offcanvas-right">
                                    <div class="horizontal-slider clearfix">
                                        <div class="col-xs-12 col-sm-12 col-md-9 main-content">
                                            ...
                                            <!--Added by BeNPaL@eScire Feb. 3, 2022-->
                                            <xsl:if test="($request-uri='')">
                                            <xsl:call-template name="steam-top" />
                                            </xsl:if>
    ...
    <!-- for the MAP by BeNPaL@eScire-->
    
 
    <xsl:template name="steam-top">
    ...
    <div class="col-sm-12" style="margin-bottom: 20px;">
        ...
        width="100%"
        height="545"
        src="http://escire.sytes.net/desarrollo-KTheia/map/5"
                ...
                <div class="container">
                    ...
                    <div class="navbar-header pull-right hidden-xs">
                        ...
                        <div>
                            ...
                            <label class="brand" for="">
                                <a>
                                    <img class="img-fluid float-xl-left" src="{$theme-path}images/oe Steam Lab LOGO.png"  width="350px"/>
                                </a>
                            </label>
                            ...
                            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                                <ul class="nav navbar-nav">
                                    <li><a  href="https://www.oer-steam.world/" target="_blank">INICIO</a></li>
                                    <li >
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            EL PROYECTO <b class="caret"></b>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="https://www.oer-steam.world/implicaciones" target="_blank">IMPLICACIONES</a></li>
                                            <li><a href="https://www.oer-steam.world/filosofia-de-gestion" target="_blank">FILOSOFÍA DE GESTIÓN</a></li>
                                            <li><a href="https://www.oer-steam.world/equipo-de-trabajo" target="_blank">EQUIPO DE TRABAJO</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="https://www.oer-steam.world/calendario" target="_blank">ACTIVIDADES</a>
                                </li>
                                    <li><a href="https://www.oer-steam.world/publicaciones" target="_blank">PUBLICACIONES</a>
                                </li>
                                    <li><a href="https://www.oer-steam.world/recursos-steam" target="_blank">RECURSOS STEAM</a>
                                </li>
                                </ul>
                            </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="hidden-print">
                                ...
                                <img src="{concat($theme-path, 'images/FOOTER.jpg')}" width="100%" height="100%"/>
